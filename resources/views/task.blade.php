...
<head>
    ...
    {{-- F-icon --}}
    <link rel="icon"
        href="https://as1.ftcdn.net/v2/jpg/05/83/61/64/1000_F_583616421_I2gICTJCaqquYwXvNJPWIvcxyJcIqT3J.jpg"
        type="image/x-icon">
    <!-- Fonts -->
            ...
            <div class="row">
                    ...
                    @foreach ($tasks as $item)
                        <ul class="">
                            <li class="border p-2 rounded">
                                <p class="text-white d-inline">{{ $item->title }}</p><a
                                    href="{{ route('singel.task', ['id' => $item->id]) }}"><button
                                        class="btn-sm ms-2">view</button></a>
                            </li>
                        </ul>
                    @endforeach
                </div>
                <div class="col">
                    ...
                    @foreach ($tasksFalse as $item)
                        <ul class="">
                            <li class="border p-2 rounded">
                                <p class="text-danger d-inline">{{ $item->title }}</p><a
                                    href="{{ route('singel.task', ['id' => $item->id]) }}"><button
                                        class="btn-sm ms-2">view</button></a>
                            </li>
                        </ul>
